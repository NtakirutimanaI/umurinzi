...
<body class="text-sm bg-gray-50 font-sans" style="margin-left:240px; margin-top:80px;">
  ...
  <div class="container mx-auto min-h-screen flex flex-col md:flex-row shadow-md bg-white rounded-lg overflow-hidden mt-4 px-4 md:px-0">
    ...
    <div class="md:w-1/2 w-full flex flex-col justify-center items-center md:items-start p-6 space-y-6 bg-white">
      ...
      <div class="space-y-3 w-full max-w-md" data-aos="fade-right">
        ...
        <a href="{{ route('admin.register_view_data') }}" id="btnReports" class="link-button link-button-blue-light" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
         <i class="fa fa-bar-chart"></i> Device Owners
        </a>


        <a href="{{ route('admin.device') }}" id="btnManage" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
        <i class="fa fa-users"></i> Registered Devices
        </a>

        <a href="{{ route('admin.technicians') }}" id="btnManage" class="link-button link-button-green" style="max-width: 160px; padding: 6px 10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
  ...
  <script>
    ...
    document.getElementById('btnRegister').addEventListener('click', (e) => {
      e.preventDefault();
      showModal(urls.btnRegister);
    });

   

    document.getElementById('btnManage').addEventListener('click', (e) => {
      e.preventDefault();
      showModal(urls.btnManage);
    });
