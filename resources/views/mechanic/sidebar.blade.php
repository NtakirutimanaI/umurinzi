...
<aside class="admin-sidebar" id="adminSidebar">
    <nav class="admin-menu">
        <a href="{{ route('mechanic.index') }}" class="admin-menu-item active">
            <i class="fa fa-dashboard"></i>
            <span class="admin-label">Dashboard</span>
        </a>

        <a href="/register_repair" class="admin-menu-item">
        ...
        <a href="/stock" class="admin-menu-item">
            ...
            <span class="admin-label">Stock</span>
        </a>

        <a href="/transactions" class="admin-menu-item">
            <i class="fa fa-file-invoice-dollar"></i>
            <span class="admin-label">Transactions</span>
        </a>

        <a href="/bookings" class="admin-menu-item">
            <i class="fa fa-calendar-check"></i>
            <span class="admin-label">Bookings</span>
        </a>

        <a href="/learning" class="admin-menu-item">
            <i class="fa fa-graduation-cap"></i>
            <span class="admin-label">Learning</span>
        </a>

        <a href="/notifications" class="admin-menu-item">
            <i class="fa fa-bell"></i>
            <span class="admin-label">Notifications</span>
        </a>
